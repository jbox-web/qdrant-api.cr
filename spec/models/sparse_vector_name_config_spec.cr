...
# Unit tests for Qdrant::Api::SparseVectorNameConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::SparseVectorNameConfig do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::SparseVectorNameConfig.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
