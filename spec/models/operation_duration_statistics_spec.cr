...
# Unit tests for Qdrant::Api::OperationDurationStatistics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::OperationDurationStatistics do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::OperationDurationStatistics.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
