...
# Unit tests for Qdrant::Api::Log10Expression
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::Log10Expression do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::Log10Expression.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
