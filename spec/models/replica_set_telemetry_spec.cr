...
# Unit tests for Qdrant::Api::ReplicaSetTelemetry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::ReplicaSetTelemetry do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::ReplicaSetTelemetry.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
