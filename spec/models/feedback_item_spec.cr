...
# Unit tests for Qdrant::Api::FeedbackItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::FeedbackItem do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::FeedbackItem.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
