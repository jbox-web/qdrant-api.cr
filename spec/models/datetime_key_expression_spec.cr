...
# Unit tests for Qdrant::Api::DatetimeKeyExpression
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::DatetimeKeyExpression do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::DatetimeKeyExpression.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
