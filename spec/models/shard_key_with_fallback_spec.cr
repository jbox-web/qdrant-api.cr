...
# Unit tests for Qdrant::Api::ShardKeyWithFallback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::ShardKeyWithFallback do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::ShardKeyWithFallback.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
