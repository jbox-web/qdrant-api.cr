...
# Unit tests for Qdrant::Api::ShardUpdateQueueInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::ShardUpdateQueueInfo do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::ShardUpdateQueueInfo.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
