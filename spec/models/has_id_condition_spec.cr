...
# Unit tests for Qdrant::Api::HasIdCondition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::HasIdCondition do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::HasIdCondition.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
