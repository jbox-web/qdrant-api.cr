...
# Unit tests for Qdrant::Api::NaiveFeedbackStrategy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe Qdrant::Api::NaiveFeedbackStrategy do
  describe "required-field enforcement" do
    ...
    it "raises when required properties are missing" do
      expect { Qdrant::Api::NaiveFeedbackStrategy.from_json("{}") }.to raise_error(JSON::SerializableError)
    end
  end
end
