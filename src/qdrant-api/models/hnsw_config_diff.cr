...
module Qdrant::Api
  class HnswConfigDiff
    ...
    def initialize(@m : Int32? = nil, @ef_construct : Int32? = nil, @full_scan_threshold : Int32? = nil, @max_indexing_threads : Int32? = nil, @on_disk : Bool? = nil, @payload_m : Int32? = nil, @inline_storage : Bool? = nil)
    end
