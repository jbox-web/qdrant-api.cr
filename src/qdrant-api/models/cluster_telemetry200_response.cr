...
module Qdrant::Api
  class ClusterTelemetry200Response
    ...
    property result : DistributedTelemetryData?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@usage : Usage? = nil, @time : Float32? = nil, @status : String? = nil, @result : DistributedTelemetryData? = nil)
    end
