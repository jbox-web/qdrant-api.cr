...
module Qdrant::Api
  ...
  class SetPayload
    ...
    def initialize(@payload : Hash(String, JSON::Any), @points : Array(ExtendedPointId)? = nil, @filter : Filter? = nil, @shard_key : ShardKeySelector? = nil, @key : String? = nil)
    end
    ...
    def_equals_and_hash(payload, points, filter, shard_key, key)
  end
end
