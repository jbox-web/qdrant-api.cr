...
module Qdrant::Api
  # ShardSnapshotLocation (OpenAPI anyOf): a value matching at least one of the listed schemas.
  ...
  class ShardSnapshotLocation
    ...
    def self.from_json_any(data : JSON::Any) : self
      ...
      raise JSON::ParseException.new("`#{json}` doesn't match any schema listed in ShardSnapshotLocation (anyOf)", 0, 0)
    end
    ...
    def self.new(ctx : YAML::ParseContext, node : YAML::Nodes::Node)
      ...
      raise YAML::ParseException.new("doesn't match any schema listed in ShardSnapshotLocation (anyOf)", 0, 0)
    end
