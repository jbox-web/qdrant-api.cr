...
module Qdrant::Api
  class NearestQuery
    ...
    # Required properties
    @[JSON::Field(key: "nearest", emit_null: false)]
    property nearest : VectorInput

    # Optional properties
    # Perform MMR (Maximal Marginal Relevance) reranking after search, using the same vector in this query to calculate relevance.
    @[JSON::Field(key: "mmr", emit_null: false)]
    property mmr : Mmr?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@nearest : VectorInput, @mmr : Mmr? = nil)
    end
    ...
    def_equals_and_hash(nearest, mmr)
  end
end
