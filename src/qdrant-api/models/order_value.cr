...
module Qdrant::Api
  # OrderValue (OpenAPI anyOf): a value matching at least one of the listed schemas.
  ...
  class OrderValue
    ...
    def self.from_json_any(data : JSON::Any) : self
      ...
      raise JSON::ParseException.new("`#{json}` doesn't match any schema listed in OrderValue (anyOf)", 0, 0)
    end
    ...
    def self.new(ctx : YAML::ParseContext, node : YAML::Nodes::Node)
      ...
      raise YAML::ParseException.new("doesn't match any schema listed in OrderValue (anyOf)", 0, 0)
    end
