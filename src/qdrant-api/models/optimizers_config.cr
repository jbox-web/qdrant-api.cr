...
module Qdrant::Api
  class OptimizersConfig
    ...
    property deleted_threshold : Float64? = 0.2

    # The minimal number of vectors in a segment, required to perform segment optimization
    @[JSON::Field(key: "vacuum_min_vector_number", emit_null: false)]
    property vacuum_min_vector_number : Int32? = 1000
    ...
    @[JSON::Field(key: "prevent_unoptimized", emit_null: false)]
    property prevent_unoptimized : Bool?

    validates(deleted_threshold, Float64, true, maximum: 1, minimum: 0)
    validates(vacuum_min_vector_number, Int32, true, minimum: 100)
    validates(default_segment_number, Int32, false, minimum: 0)
    validates(max_segment_size, Int32, true, minimum: 1)
    ...
    def initialize(@default_segment_number : Int32, @flush_interval_sec : Int32, @deleted_threshold : Float64? = 0.2, @vacuum_min_vector_number : Int32? = 1000, @max_segment_size : Int32? = nil, @memmap_threshold : Int32? = nil, @indexing_threshold : Int32? = nil, @max_optimization_threads : Int32? = nil, @prevent_unoptimized : Bool? = nil)
    end
    ...
    def_equals_and_hash(deleted_threshold, vacuum_min_vector_number, default_segment_number, max_segment_size, memmap_threshold, indexing_threshold, flush_interval_sec, max_optimization_threads, prevent_unoptimized)
  end
end
