...
module Qdrant::Api
  class OptimizersConfigDiff
    ...
    property max_optimization_threads : MaxOptimizationThreads?
    ...
    def initialize(@deleted_threshold : Float64? = nil, @vacuum_min_vector_number : Int32? = nil, @default_segment_number : Int32? = nil, @max_segment_size : Int32? = nil, @memmap_threshold : Int32? = nil, @indexing_threshold : Int32? = nil, @flush_interval_sec : Int32? = nil, @max_optimization_threads : MaxOptimizationThreads? = nil, @prevent_unoptimized : Bool? = nil)
    end
