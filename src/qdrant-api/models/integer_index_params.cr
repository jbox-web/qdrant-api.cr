...
module Qdrant::Api
  class IntegerIndexParams
    ...
    def initialize(@_type : IntegerIndexType, @lookup : Bool? = nil, @range : Bool? = nil, @is_principal : Bool? = nil, @on_disk : Bool? = nil, @enable_hnsw : Bool? = nil)
    end
    ...
    def_equals_and_hash(_type, lookup, range, is_principal, on_disk, enable_hnsw)
  end
end
