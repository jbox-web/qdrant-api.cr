...
module Qdrant::Api
  ...
  class GeoRadius
    ...
    # Required properties
    @[JSON::Field(key: "center", emit_null: false)]
    property center : GeoPoint

    # Radius of the area in meters
    @[JSON::Field(key: "radius", emit_null: false)]
    property radius : Float64

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@center : GeoPoint, @radius : Float64)
    end
    ...
    def_equals_and_hash(center, radius)
  end
end
