...
module Qdrant::Api
  class ListShardKeys200Response
    ...
    property result : ShardKeysResponse?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@usage : Usage? = nil, @time : Float32? = nil, @status : String? = nil, @result : ShardKeysResponse? = nil)
    end
