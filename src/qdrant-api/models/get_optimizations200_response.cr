...
module Qdrant::Api
  class GetOptimizations200Response
    ...
    property result : OptimizationsResponse?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@usage : Usage? = nil, @time : Float32? = nil, @status : String? = nil, @result : OptimizationsResponse? = nil)
    end
