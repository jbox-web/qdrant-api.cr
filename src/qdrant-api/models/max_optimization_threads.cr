...
module Qdrant::Api
  # MaxOptimizationThreads (OpenAPI anyOf): a value matching at least one of the listed schemas.
  ...
  class MaxOptimizationThreads
    ...
    def initialize(@value : MaxOptimizationThreadsSetting)
    end

    # List of classes defined in anyOf (OpenAPI v3)
    def self.openapi_any_of
      [
        Int32, MaxOptimizationThreadsSetting,
      ]
    end
    ...
    def self.from_json_any(data : JSON::Any) : self
      ...
      begin
        return new(MaxOptimizationThreadsSetting.from_json(json))
      rescue JSON::ParseException | ArgumentError | TypeCastError
      end
      raise JSON::ParseException.new("`#{json}` doesn't match any schema listed in MaxOptimizationThreads (anyOf)", 0, 0)
    end
    ...
    def self.new(ctx : YAML::ParseContext, node : YAML::Nodes::Node)
      ...
      begin
        return new(MaxOptimizationThreadsSetting.new(ctx, node))
      rescue YAML::ParseException | ArgumentError | TypeCastError
      end
      raise YAML::ParseException.new("doesn't match any schema listed in MaxOptimizationThreads (anyOf)", 0, 0)
    end
