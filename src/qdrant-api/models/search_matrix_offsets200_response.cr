...
module Qdrant::Api
  class SearchMatrixOffsets200Response
    ...
    property result : SearchMatrixOffsetsResponse?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@usage : Usage? = nil, @time : Float32? = nil, @status : String? = nil, @result : SearchMatrixOffsetsResponse? = nil)
    end
    ...
    def_equals_and_hash(usage, time, status, result)
  end
end
