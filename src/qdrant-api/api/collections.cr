...
module Qdrant::Api
  class Collections
    ...
    def facet(collection_name : String, facet_request : Qdrant::Api::FacetRequest? = nil, *, consistency : Qdrant::Api::ReadConsistency? = nil, timeout : Int32? = nil) : Response(Qdrant::Api::Facet200Response)
    ...
    def optimizations(collection_name : String, *, _with : String? = nil, completed_limit : Int32? = nil) : Response(Qdrant::Api::GetOptimizations200Response)
      @conn.request(Qdrant::Api::GetOptimizations200Response,
        method: :GET,
        path: "/collections/{collection_name}/optimizations".sub("{collection_name}", Qdrant::Api.enc(collection_name)),
        query: {"with" => _with, "completed_limit" => completed_limit},
        accept: %w[application/json],
        auth: %w[api-key bearerAuth])
    end
