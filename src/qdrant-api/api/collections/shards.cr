...
module Qdrant::Api
  class Collections::Shards
    ...
    def list(collection_name : String) : Response(Qdrant::Api::ListShardKeys200Response)
      @conn.request(Qdrant::Api::ListShardKeys200Response,
        method: :GET,
        path: "/collections/{collection_name}/shards".sub("{collection_name}", Qdrant::Api.enc(collection_name)),
        accept: %w[application/json],
        auth: %w[api-key bearerAuth])
    ...
    def snapshot(collection_name : String, shard_id : Int32) : Response(::File)
      @conn.request(::File,
        method: :GET,
        path: "/collections/{collection_name}/shards/{shard_id}/snapshot".sub("{collection_name}", Qdrant::Api.enc(collection_name)).sub("{shard_id}", Qdrant::Api.enc(shard_id)),
    ...
    def snapshots_delete(collection_name : String, shard_id : Int32, snapshot_name : String, *, wait : Bool? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
      @conn.request(Qdrant::Api::RecoverFromUploadedSnapshot200Response,
        method: :DELETE,
    ...
    def snapshots_recover(collection_name : String, shard_id : Int32, shard_snapshot_recover : Qdrant::Api::ShardSnapshotRecover? = nil, *, wait : Bool? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
      @conn.request(Qdrant::Api::RecoverFromUploadedSnapshot200Response,
        method: :PUT,
    ...
    def snapshots_upload(collection_name : String, shard_id : Int32, snapshot : ::File? = nil, *, wait : Bool? = nil, priority : Qdrant::Api::SnapshotPriority? = nil, checksum : String? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
      @conn.request(Qdrant::Api::RecoverFromUploadedSnapshot200Response,
        method: :POST,
