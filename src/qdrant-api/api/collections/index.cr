...
module Qdrant::Api
  class Collections::Index
    ...
    def bulk_update(collection_name : String, create_field_index : Qdrant::Api::CreateFieldIndex? = nil, *, wait : Bool? = nil, ordering : Qdrant::Api::WriteOrdering? = nil, timeout : Int32? = nil) : Response(Qdrant::Api::CreateFieldIndex200Response)
    ...
    def delete(collection_name : String, field_name : String, *, wait : Bool? = nil, ordering : Qdrant::Api::WriteOrdering? = nil, timeout : Int32? = nil) : Response(Qdrant::Api::CreateFieldIndex200Response)
      @conn.request(Qdrant::Api::CreateFieldIndex200Response,
        method: :DELETE,
