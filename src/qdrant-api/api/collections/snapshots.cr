...
module Qdrant::Api
  class Collections::Snapshots
    ...
    def delete(collection_name : String, snapshot_name : String, *, wait : Bool? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
    ...
    def recover(collection_name : String, snapshot_recover : Qdrant::Api::SnapshotRecover? = nil, *, wait : Bool? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
      @conn.request(Qdrant::Api::RecoverFromUploadedSnapshot200Response,
        method: :PUT,
    ...
    def upload(collection_name : String, snapshot : ::File? = nil, *, wait : Bool? = nil, priority : Qdrant::Api::SnapshotPriority? = nil, checksum : String? = nil) : Response(Qdrant::Api::RecoverFromUploadedSnapshot200Response)
      @conn.request(Qdrant::Api::RecoverFromUploadedSnapshot200Response,
        method: :POST,
